<template>
  <div class="burgundy-bg">
    <h2 class="section-title text-white text-center q-mb-xl">Your Next Employer Might Be Here</h2>
...
export default {
  ...
  mounted() {
    ...
    store.fetchCompanies() // Simulated fetch
  },
}
</script>
...
<style scoped>
.burgundy-bg {
  background: linear-gradient(180deg, #2b0a3d 0%, #23122e 100%);
  padding: 2rem;
  min-height: 80vh;
}
