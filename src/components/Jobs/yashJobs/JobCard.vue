          ...
          <div class="col-4 col-md-4 text-right">
            <div class="row items-center justify-end q-gutter-sm no-wrap">
              ...
              <q-btn
                ...
                label="Apply"
                :class="
                  userStore.token === null ? 'btn-disabled' : 'btn-outline-black equal-button'
                "
                type="button"
              ...
              <q-btn
                ...
                dense
                label="Learn"
                :class="userStore.token === null ? 'btn-disabled' : 'btn-filled-black equal-button'"
                type="button"
...
export default {
  ...
  methods: {
    ...
    async applyForJob() {
      ...
      console.log('Apply clicked for jobid:', this.normalizedJob.jobid)
    ...
    async learnMoreForJob() {
      ...
      console.log('Learn More clicked for jobid:', this.normalizedJob.jobid)
    ...
    async openCompanyDialog() {
      ...
      console.log('Opening company dialog for cid:', this.normalizedJob.cid)
